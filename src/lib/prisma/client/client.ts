 ...
 * 
 */
export type UserChoice = Prisma.UserChoiceModel
/**
 * Model Affinity
 * 
 */
export type Affinity = Prisma.AffinityModel

export type ChoiceType = $Enums.ChoiceType
export const ChoiceType = $Enums.ChoiceType

export type AffinityType = $Enums.AffinityType
export const AffinityType = $Enums.AffinityType
