...
function ToastList() {
  ...
  return toasts.map((toast) => (
    ...
    >
      <Toast.Title className="text-[0.975rem] leading-5 font-semibold m-0 mb-[5px]">
        {toast.title}
      </Toast.Title>
      <Toast.Description className="text-[0.925rem] leading-5 text-muted-foreground">
        {toast.description}
      </Toast.Description>
      <Toast.Close
        aria-label="Close"
