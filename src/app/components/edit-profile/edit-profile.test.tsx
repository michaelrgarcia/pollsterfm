...
import { headerImageSchemaMessage } from "@/lib/schemas/user";
...
describe("EditProfile", () => {
  describe("file uploads", () => {
    ...
    it("non-image file fail", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(headerImageSchemaMessage)).toBeInTheDocument();
      });
    });
  ...
  it("makes a toast for updateProfile errors", async () => {
    const mockedVerify = vi.mocked(updateProfile);
