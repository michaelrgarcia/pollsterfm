    ...
    <div className="mb-6 flex flex-col gap-4 border-b pb-6 sm:flex-row sm:items-center">
      ...
      <div className="mt-3 flex-1 text-center sm:mt-0 sm:text-left">
        <div className="mb-1 flex flex-wrap justify-center gap-2 sm:justify-start">
          <div className="skeleton h-3.5 w-20 animate-pulse rounded-full"></div>
        </div>
        <div className="skeleton mx-auto my-0 h-3.5 w-38 animate-pulse rounded-lg sm:m-0"></div>
        <div className="skeleton mx-auto mt-1 mb-0 flex h-3.5 w-55 animate-pulse justify-center gap-1 rounded-lg sm:mx-0 sm:justify-start"></div>
      </div>
